...
public class Warden_Complaint_Activity extends AppCompatActivity implements View.OnClickListener {

    String value="true";
    RelativeLayout backarrow,btnsendComplaint;
    ListView listView;
    public Warden_Complaint_Adapter listviewadapter;
    ScrollView laysendcompaint;
    Context lcontext;
    String result,useridvalue,propertyidvalue_new,propertyownerid,wardenid;
    ...
    String TenantName,Complaint,ComplaintType,warden_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        warden_name=ii.getStringExtra("WardenName");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(Warden_Complaint_Activity.this,Warden_Complaint_Chat_Activity.class);
                ...
                intent.putExtra("Warden_Name",warden_name);
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            Intent ii=new Intent(Warden_Complaint_Activity.this,HostelListActivity.class);
            startActivity(ii);
            }
        });
    ...
    // Method/Dailog for show Tenant name
    private void GetTenantName() {
        month_dialog=new Dialog(Warden_Complaint_Activity.this);
        ...
        if(NetworkConnection.isConnected(Warden_Complaint_Activity.this))
        {
    ...
    // Method/Dailog for show complaint head
    public void getComplaintheadDialog() {
        complaintype = new Dialog(Warden_Complaint_Activity.this);
        ...
        Month_Custom_List adapter_data_month = new Month_Custom_List(Warden_Complaint_Activity.this, complaint);
    ...
    //this class used to show complaint list
    public class GetTenantComplaint extends AsyncTask<String, String, String> {

        private ProgressDialog dialog = new ProgressDialog(Warden_Complaint_Activity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            listNameValuePairs.add(new BasicNameValuePair("action","getwardencomplainlist"));
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("Y")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            commodel.setSender_name(jsonObject.getString("sender_name_first"));
                        ...
                        for(int n=0;n<arraylistdetail.size();n++){
                            ...
                            detailmodel.setSendername(arraylistdetail.get(n).getSender_name());
                        ...
                        listviewadapter=new Warden_Complaint_Adapter(lcontext,arraylistdetail,arraylistdetailnew);
    ...
    //this class used to get tenant details
            ...
            student_loader.setVisibility(View.GONE);
                ...
                if (result.equalsIgnoreCase("true")) {
                    if (ownerstudentarraylist.size() > 0) {
                        ...
                        adapter_data_month = new OwnerStudentNameTanentAdapter(Warden_Complaint_Activity.this,ownerstudentarraylist);
                        student_list_dialog.setAdapter(adapter_data_month);
                    }
                } else if (result.equalsIgnoreCase("false")) {
                    Toast.makeText(Warden_Complaint_Activity.this,"No Tanent Found", Toast.LENGTH_LONG).show();
                }
        }
    }
    ...
    protected String doInBackground(String... params) {
        ...
        ArrayList<NameValuePair> listNameValuePairs;
        listNameValuePairs = new ArrayList<NameValuePair>();
        listNameValuePairs.add(new BasicNameValuePair("action", "warden_complain"));
        ...
        listNameValuePairs.add(new BasicNameValuePair("warden_name",warden_name));
        url = WebUrls.MAIN_URL;
        result = Utility.postParamsAndfindJSON(url, listNameValuePairs);
    ...
    protected void onPostExecute(String result) {
        ...
        if (result == null) {
            ...
            try {
                ...
                if (status.equalsIgnoreCase("Y")) {
                    Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(Warden_Complaint_Activity.this,Warden_Complaint_Activity.class);
                    intent.putExtra("Ownerid",propertyownerid);
                    intent.putExtra("Propertyid", propertyidvalue_new);
                    intent.putExtra("Wardenid", wardenid);
                    intent.putExtra("WardenName", warden_name);
                    startActivity(intent);
                    hideSoftKeyboard(Warden_Complaint_Activity.this);
                } else {
                    Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_SHORT).show();
                }
