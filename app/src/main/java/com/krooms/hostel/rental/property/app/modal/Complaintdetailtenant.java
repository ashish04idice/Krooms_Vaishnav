 ...
 */
public class Complaintdetailtenant {


    String Id,Check_Reply,Status,ownercounttotal,Owner_name,Owner_Propertyid,Owner_id,Owner_userid,Owner_complainttype,Owner_complaintdescription,Time,Date,Complaint_id,Tenant_name,Tenant_id,Tenant_roomno,Parent_id,Warden_id;
    ...
    public String getOwner_complainttype() {
        return Owner_complainttype;
    }

    public void setOwner_complainttype(String owner_complainttype) {
        Owner_complainttype = owner_complainttype;
    }

    public String getOwner_complaintdescription() {
        return Owner_complaintdescription;
    }

    public void setOwner_complaintdescription(String owner_complaintdescription) {
        Owner_complaintdescription = owner_complaintdescription;
    }
