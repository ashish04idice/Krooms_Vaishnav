 ...
 */
public class GetTenatInfoFromTransactionTableAsyncTask  extends AsyncTask<String, Void, String> {
    ...
    public GetTenatInfoFromTransactionTableAsyncTask(Activity activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            locationData.put("action", "getTanentInfoByUserId");
