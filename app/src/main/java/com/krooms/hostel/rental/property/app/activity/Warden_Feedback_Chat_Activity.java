...
import com.krooms.hostel.rental.property.app.adapter.WardenFeedbackChatAdapter;
 ...
 */
public class Warden_Feedback_Chat_Activity extends AppCompatActivity {
    ...
    TextView sendreply;
    String maincomplaintid, WardenId, wardenname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Warden_Feedback_Chat_Activity.this, Warden_Feedback_Activity.class);
                i.putExtra("Ownerid", OwnerId);
                i.putExtra("Propertyid", PropertyId);
                i.putExtra("Wardenid", WardenId);
                i.putExtra("Wardenname", wardenname);
                startActivity(i);
        ...
        sendreply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (descriptionvalue.equals("")) {
                    Toast.makeText(Warden_Feedback_Chat_Activity.this, "please enter description", Toast.LENGTH_SHORT).show();
    ...
    public class getEventdataJsonCalss extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(Warden_Feedback_Chat_Activity.this);
        ...
        protected void onPostExecute(String th) {
            ...
            if (result.equals("Y")) {
                WardenFeedbackChatAdapter adapter = new WardenFeedbackChatAdapter(Warden_Feedback_Chat_Activity.this, mainarraylist, wardenname);
                listView.setAdapter(adapter);
            } else {
                Toast.makeText(Warden_Feedback_Chat_Activity.this, message, Toast.LENGTH_SHORT).show();
            }
    ...
    public class SendComplaintJsonCalss extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                listNameValuePairs.add(new BasicNameValuePair("action", "warden_feedback_reply"));
        ...
        protected void onPostExecute(String th) {
            ...
            if (result.equals("Y")) {
                ...
                Intent i = new Intent(Warden_Feedback_Chat_Activity.this, Warden_Feedback_Chat_Activity.class);
    ...
    // This class is used to send warden feedback seen status to server
    public class GetTenantFeedbackSeen extends AsyncTask<String, String, String> {

        private ProgressDialog dialog = new ProgressDialog(Warden_Feedback_Chat_Activity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            listNameValuePairs.add(new BasicNameValuePair("action", "warden_feedback_read_msg"));
            listNameValuePairs.add(new BasicNameValuePair("feedback_id", ComplaintId));
