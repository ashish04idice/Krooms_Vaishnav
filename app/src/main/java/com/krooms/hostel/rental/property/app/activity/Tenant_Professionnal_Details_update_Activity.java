...
/**
 * Created by Raghveer on 27-03-2017.
 */
public class Tenant_Professionnal_Details_update_Activity extends AppCompatActivity implements View.OnClickListener,
    ...
    private String _isImageFlag = "", Userid_tenant = "";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        tidvalue = getIntent().getStringExtra("RcuTenantID");
        createViews();
        setListeners();
        GetIntentValues();
        setDataUpdata();
    ...
    private void GetIntentValues() {
        ...
        Intent in = getIntent();
        Userid_tenant = in.getStringExtra("user_id_tenant");
        RcuTenantID = in.getStringExtra("RcuTenantID");
        Tofc_institute = in.getStringExtra("Tofc_institutename");
        ...
        Totherdetail = in.getStringExtra("Totherdetail");
    ...
    private void createViews() {
        ...
        btntermscondition.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String propertyid = "";
                mSharedStorage = SharedStorage.getInstance(Tenant_Professionnal_Details_update_Activity.this);
                ...
                Intent intent = new Intent(Tenant_Professionnal_Details_update_Activity.this, TermsAndCondition_ActivityDailog.class);
                intent.putExtra("Tenantid", RcuTenantID);
...
//        if (isUpdate) {
        ...
        edtOfficeAddress.setText(Tofficeaddress);
        edtUserName.setText(Tguarantorname);
        edtProfContactno.setText(Tofc_contact);
        edtGuarantorContactno.setText(Tguarantorcontact);
        edtAdddress.setText(Tguarantoraddress);
        edtVehicleno.setText(TVehicleRegistrationNo);
        edtVoterId.setText(TVoteridcardno);
        edtDrivingLicno.setText(TDrivinglicenseNo);
        edtAadhaarCardno.setText(TAadharcardNo);
        edtArmLicenseno.setText(TArmlicenceNo);
        edtInfoPhoneno.setText(TsformTelephoneNo);
        nameOfIssuingOfcDrivingLicens.setText(TDrivinglicenseIssuename);
        nameOfIssuingOfcArmLicens.setText(TArmlicenceIssuename);
        edtPassport.setText(TPassportNo);
        edtRashanCard.setText(TRashanCardNo);
        edtOtherId.setText(TOtherIdno);
        edtDetailVerification.setText(Totherdetail);
        edtMobileno.setText(TsformMobileNo);
        workDetail = Twork_detail;
        ...
        if (!TVehicleRegistrationPhoto.equals("")) {
            ...
            String filename = TVehicleRegistrationPhoto.substring(TVehicleRegistrationPhoto.lastIndexOf("/") + 1);
            ...
            modal.setIdProofImagePath(TVehicleRegistrationPhoto);
            modal.setIdProofType("vehicle");
            idProofModal.add(modal);
            imgVehicleId = WebUrls.IMG_URL + "" + TVehicleRegistrationPhoto;
            vehicle_nodoc_img.setVisibility(View.VISIBLE);
            Common.loadImage(mContext, imgVehicleId, vehicle_nodoc_img);
        }
        if (!TVoteridcardPhoto.equals("")) {


            String filename = TVoteridcardPhoto.substring
                    (TVoteridcardPhoto.lastIndexOf("/") + 1);
            btnVoteridImage.setText("" + filename);
            TenantUserIdProofModal modal = new TenantUserIdProofModal();
            modal.setFromLocalOrServer(TenantUserIdProofModal.FROMSERVER);
            modal.setIdProofImagePath(TVoteridcardPhoto);
            ...
            imgVoterId = WebUrls.IMG_URL + "" + TVoteridcardPhoto;
                /*Picasso.with(this)
                        .load(imgVoterId)
        ...
        if (!TDrivinglicensePhoto.equals("")) {
            ...
            String filename = TDrivinglicensePhoto.substring(
                    TDrivinglicensePhoto.lastIndexOf("/") + 1);
            btnDrivingLicImage.setText("" + filename);
            TenantUserIdProofModal modal = new TenantUserIdProofModal();
            modal.setFromLocalOrServer(TenantUserIdProofModal.FROMSERVER);
            modal.setIdProofImagePath(TDrivinglicensePhoto);

            modal.setIdProofType("driving");
            idProofModal.add(modal);
            driving_lic_nodoc_img.setVisibility(View.VISIBLE);

            imgDrivingLicense = WebUrls.IMG_URL + "" + TDrivinglicensePhoto;
                /*Picasso.with(this)
        ...
        if (!TAadharcardPhoto.equals("")) {
            String filename = TAadharcardPhoto.substring(
                    TAadharcardPhoto.lastIndexOf("/") + 1);
            btnAadhaarCardImage.setText("" + filename);
            TenantUserIdProofModal modal = new TenantUserIdProofModal();
            modal.setFromLocalOrServer(TenantUserIdProofModal.FROMSERVER);
            modal.setIdProofImagePath(TAadharcardPhoto);
//                vehicle ,  voter ,  driving ,  rashan ,  aadhar ,  arm
            modal.setIdProofType("aadhar");
            idProofModal.add(modal);
            aadhaar_card_nodoc_img.setVisibility(View.VISIBLE);
            imgAadhaarCard = WebUrls.IMG_URL + "" + TAadharcardPhoto;
                /*Picasso.with(this)
                        .load(imgAadhaarCard)
                        .placeholder(R.drawable.ic_default_background)
                        .error(R.drawable.ic_default_background)
        ...
        if (!TArmlicencePhoto.equals("")) {
            String filename = TArmlicencePhoto.substring(
                    TArmlicencePhoto.lastIndexOf("/") + 1);
            btnArmLicensImage.setText("" + filename);
            TenantUserIdProofModal modal = new TenantUserIdProofModal();
            modal.setFromLocalOrServer(TenantUserIdProofModal.FROMSERVER);
            modal.setIdProofImagePath(TArmlicencePhoto);
            modal.setIdProofType("arm");
            idProofModal.add(modal);
            arm_licences_nodoc_img.setVisibility(View.VISIBLE);
            imgArmLicId = WebUrls.IMG_URL + "" + TArmlicencePhoto;
                /*Picasso.with(this)
                        .load(imgArmLicId)
                        .placeholder(R.drawable.ic_default_background)
                        .error(R.drawable.ic_default_background)
        ...
        if (!TPassportPhoto.equals("")) {
            String filename = TPassportPhoto.substring(
                    TPassportPhoto.lastIndexOf("/") + 1);
            btnPassportImage.setText("" + filename);
            TenantUserIdProofModal modal = new TenantUserIdProofModal();
            modal.setFromLocalOrServer(TenantUserIdProofModal.FROMSERVER);
            modal.setIdProofImagePath(TPassportPhoto);
            modal.setIdProofType("passport");
            idProofModal.add(modal);
            passport_doc_img.setVisibility(View.VISIBLE);
            imgPassport = WebUrls.IMG_URL + "" + TPassportPhoto;
                /*Picasso.with(this)
                        .load(imgPassport)
                        .placeholder(R.drawable.ic_default_background)
                        .error(R.drawable.ic_default_background)
        ...
        if (!TRashanCardPhoto.equals("")) {
            String filename = TRashanCardPhoto.substring(
                    TRashanCardPhoto.lastIndexOf("/") + 1);
            btnRashanCardImage.setText("" + filename);
            TenantUserIdProofModal modal = new TenantUserIdProofModal();
            modal.setFromLocalOrServer(TenantUserIdProofModal.FROMSERVER);
            modal.setIdProofImagePath(TRashanCardPhoto);
            modal.setIdProofType("rashan");
            idProofModal.add(modal);
            rashanCard_doc_img.setVisibility(View.VISIBLE);
            imgRashanCard = WebUrls.IMG_URL + "" + TRashanCardPhoto;
                /*Picasso.with(this)
                        .load(imgRashanCard)
                        .placeholder(R.drawable.ic_default_background)
                        .error(R.drawable.ic_default_background)
        ...
        if (!TOtherIdPhoto.equals("")) {
            String filename = TOtherIdPhoto.substring(
                    TOtherIdPhoto.lastIndexOf("/") + 1);
            btnOtherIdImage.setText("" + filename);
            TenantUserIdProofModal modal = new TenantUserIdProofModal();
            modal.setFromLocalOrServer(TenantUserIdProofModal.FROMSERVER);
            modal.setIdProofImagePath(TOtherIdPhoto);
            modal.setIdProofType("other");
            idProofModal.add(modal);
            other_doc_img.setVisibility(View.VISIBLE);
            imgOtherId = WebUrls.IMG_URL + "" + TOtherIdPhoto;
                /*Picasso.with(this)
                        .load(imgOtherId)
                        .placeholder(R.drawable.ic_default_background)
                        .error(R.drawable.ic_default_background)
...
*/
                CustomDialogClassFullScreen cdd = new CustomDialogClassFullScreen(Tenant_Professionnal_Details_update_Activity.this);
...
*/
                CustomDialogClassFullScreen cddVoterid = new CustomDialogClassFullScreen(Tenant_Professionnal_Details_update_Activity.this);
            ...
            case R.id.driving_lic_nodoc_img:
                ...
                */
                CustomDialogClassFullScreen cddDriving = new CustomDialogClassFullScreen(Tenant_Professionnal_Details_update_Activity.this);
...
*/
                CustomDialogClassFullScreen cddAadhaar = new CustomDialogClassFullScreen(Tenant_Professionnal_Details_update_Activity.this);
...
*/
                CustomDialogClassFullScreen cddArm = new CustomDialogClassFullScreen(Tenant_Professionnal_Details_update_Activity.this);
            ...
            case R.id.pasport_doc_img:
              ...
              /*  ImagePreviewDialog passportImagePreviewDialog = new ImagePreviewDialog() {
                    @Override
                    public void showImage(ImageView img) {
                        Common.loadImage(mContext, imgPassport, img);//PassPort
                    }
               ...
               */
                CustomDialogClassFullScreen cddPassPort = new CustomDialogClassFullScreen(Tenant_Professionnal_Details_update_Activity.this);
            ...
            case R.id.RashanCard_doc_img:
               ...
               /* ImagePreviewDialog rashanCardImagePreviewDialog = new ImagePreviewDialog() {
                ...
                CustomDialogClassFullScreen cddRashan = new CustomDialogClassFullScreen(Tenant_Professionnal_Details_update_Activity.this);
            ...
            case R.id.otherIdentityCard_doc_img:
                ...
                /*ImagePreviewDialog otherIdPreviewDialog = new ImagePreviewDialog() {
                    @Override
                    public void showImage(ImageView img) {
                        Common.loadImage(mContext, imgOtherId, img);//Other Id
                    }
...
*/
                CustomDialogClassFullScreen cddOther = new CustomDialogClassFullScreen(Tenant_Professionnal_Details_update_Activity.this);
    ...
    public void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Tenant_Professionnal_Details_update_Activity.this);
        builder.setTitle("Select Image");
        ArrayAdapter<String> adapter = new ArrayAdapter<>(Tenant_Professionnal_Details_update_Activity.this, android.R.layout.simple_list_item_1);
                ...
                switch (which) {
                    case 0:
                        if (UtilityImg.isExternalStorageAvailable()) {
                            ...
                            Toast toast = Toast.makeText(Tenant_Professionnal_Details_update_Activity.this, "Please give internal storage permission", Toast.LENGTH_SHORT);
    ...
    private Uri getPhotoFileURI() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            uri = UtilityImg.getExternalFilesDirForVersion24Above(Tenant_Professionnal_Details_update_Activity.this, Environment.DIRECTORY_PICTURES, APP_TAG, fileName);
        } else {
            uri = UtilityImg.getExternalFilesDirForVersion24Below(Tenant_Professionnal_Details_update_Activity.this, Environment.DIRECTORY_PICTURES, APP_TAG, fileName);
        }
        return uri;
    }
            ...
            if (resultCode == RESULT_OK) {
                ...
                try {
                    if (resultUri != null) {
                        ...
                        String rcuId = RcuTenantID;
                        callIdProofImage(Userid_tenant, rcuId, _isImageFlag, Common.profileImagePath);
    ...
    public void submitBtnClickEvent() {
        ...
        try {
            ...
            if (vehicleNo.length() == 0 && voterId.length() == 0 && drivingLincenceno.length() == 0 &&
                ...
                Toast.makeText(Tenant_Professionnal_Details_update_Activity.this, "Enter atleast one id proof no/id.", Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            if (result.equalsIgnoreCase("ConnectTimeoutException")) {
                ...
                if (status.equals("true")) {
                    reSetData();
                    Intent in = new Intent(Tenant_Professionnal_Details_update_Activity.this, HostelListActivity.class);
                    startActivity(in);
...
*/
        CustomDialogClass cdd = new CustomDialogClass(Tenant_Professionnal_Details_update_Activity.this, R.style.full_screen_dialog);
        cdd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public class CustomDialogClass extends Dialog {
        ...
        public CustomDialogClass(Tenant_Professionnal_Details_update_Activity a, int full_screen_dialog) {
    ...
    public class CustomDialogClassFullScreen extends Dialog {
        ...
        public CustomDialogClassFullScreen(Tenant_Professionnal_Details_update_Activity a) {
            super(a);
            // TODO Auto-generated constructor stub
            //this.c = a;
        }
