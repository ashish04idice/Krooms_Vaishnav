...
public class BillingShippingTanentActivity extends Activity {
    ...
    public void onClick(View view) {
        ...
        if (selectedCardType != null && selectedPaymentOption != null && !vOrderId.equals("") && !vRsaKeyUrl.equals("")) {
            Intent intent = new Intent(this, WebViewTanentActivity.class);
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(BillingShippingTanentActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                PayOptAdapter payOptAdapter = new PayOptAdapter(BillingShippingTanentActivity.this, android.R.layout.simple_spinner_item, payOptionList);
...
//							((LinearLayout) findViewById(R.id.cardDetails)).setVisibility(View.VISIBLE);
                            ...
                            EMIAdapter emiAdapter = new EMIAdapter(BillingShippingTanentActivity.this, android.R.layout.simple_spinner_item, emiOptionList);
                            ...
                            emiOption.setOnItemSelectedListener(new OnItemSelectedListener() {
                                ...
                                public void onItemSelected(AdapterView parent, View view, int position, long id) {
                                    ...
                                    CardNameAdapter cardNameAdapter = new CardNameAdapter(BillingShippingTanentActivity.this, android.R.layout.simple_spinner_item, cardNameList);
                                    ...
                                    RadioGroup rg = new RadioGroup(BillingShippingTanentActivity.this);
                                    rg.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                                        public void onCheckedChanged(RadioGroup group, int checkedId) {
                                            try {
                                                ...
                                                TextView vProcFee = new TextView(BillingShippingTanentActivity.this);
                                    ...
                                    while (vEmiPlanIt.hasNext()) {
                                        ...
                                        RadioButton rb = new RadioButton(BillingShippingTanentActivity.this);
                            ...
                            CardAdapter cardTypeAdapter = new CardAdapter(BillingShippingTanentActivity.this, android.R.layout.simple_spinner_item, cardsList.get(selectedPaymentOption));
                    ...
                    if (jsonRespObj != null) {
                        if (jsonRespObj.getString("CustPayments") != null) {
                            ...
                            if (vJsonArr.length() > 0) {
                                ...
                                final LinearLayout vVaultOptionsCont = new LinearLayout(BillingShippingTanentActivity.this);
                                vVaultOptionsCont.setId(R.id.vaultCont);
                                vVaultOptionsCont.setOrientation(LinearLayout.VERTICAL);
                                TextView tv = new TextView(BillingShippingTanentActivity.this);
                                ...
                                final CheckBox vChb = new CheckBox(BillingShippingTanentActivity.this);
    ...
    private class PaymentActivityOwnerJSONParse extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("property_id", PaymentActivityTanent.propertyid_value));
        ...
        protected void onPostExecute(String result) {
            ...
            if (!IsError) {
                if (result.equalsIgnoreCase("Y")) {
                    ...
                    Toast.makeText(BillingShippingTanentActivity.this, "Payment is successfull", Toast.LENGTH_LONG).show();

                } else if (result.equals("N")) {
                    Toast.makeText(BillingShippingTanentActivity.this, message, Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(BillingShippingTanentActivity.this, "please check network connection", Toast.LENGTH_LONG).show();
            }
