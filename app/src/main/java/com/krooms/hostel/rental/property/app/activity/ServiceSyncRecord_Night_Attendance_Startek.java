...
public class ServiceSyncRecord_Night_Attendance_Startek extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        handlerdb = new DatabaseHandlerStartak_Sdk(ServiceSyncRecord_Night_Attendance_Startek.this);
        db = handlerdb.getWritableDatabase();
        versionCode = Utility.getSharedPreferences(ServiceSyncRecord_Night_Attendance_Startek.this, "GetVersion");
        mSharedStorage = SharedStorage.getInstance(this);
        propertyid = mSharedStorage.getUserPropertyId();

        mTimer = new Timer();

        if (NetworkConnection.isConnected(ServiceSyncRecord_Night_Attendance_Startek.this)) {
            ...
            try {
                ...
                e.printStackTrace();
                AppError.handleUncaughtException(e, "ServiceSyncRecord_Night_Attendance_Startek - onStartCommand", propertyid, versionCode);
            }
        } else {
        }
        return START_STICKY;
    ...
    private void sendOfflineattendance() {
        ...
        try {
            ...
            AppError.handleUncaughtException(e, " ServiceSyncRecord_Night_Attendance_Startek - nightattendance_list", propertyid, versionCode);
    ...
    public void Sendofflinehostelattendance(final JSONArray jArraynight) {
        try {
            StringRequest postRequest = new StringRequest(Request.Method.POST, WebUrls.MAIN_ATTENDACE_URL,
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            AppError.handleUncaughtException(error, " ServiceSyncRecord_Night_Attendance_Startek - onErrorResponse", propertyid, versionCode);
            ...
            /*RequestQueue requestQueue = Volley.newRequestQueue(ServiceSyncRecord_Night_Attendance_Startek.this);
            requestQueue.add(postRequest);*/
            App.getInstance().addToRequestQueue(postRequest, "tag6");

        } catch (Exception e) {
            e.printStackTrace();

            AppError.handleUncaughtException(e, " ServiceSyncRecord_Night_Attendance_Startek - Sendofflinehostelattendance apicall", propertyid, versionCode);
    ...
    public void getResponsetenantlist(String resultobj) {
        try {
            ...
            e.printStackTrace();
            AppError.handleUncaughtException(e, " ServiceSyncRecord_Night_Attendance_Startek - getResponsetenantlist", propertyid, versionCode);
        }
    }
