...
import com.krooms.hostel.rental.property.app.adapter.ListShowParentfeedbackAdapter;
...
public class Parent_Feedback_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView txtcomplainspinner, txttenantname, titlename;
    ...
    ListShowParentfeedbackAdapter listviewshowcomplaintadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parent_feedback_layout);
        ...
        mShared.getBookedPropertyId();
        String aa = mShared.getBookedPropertyId();
        complainspinner = (LinearLayout) findViewById(R.id.pcomplainnamelayout);
        tenantnamespinner = (LinearLayout) findViewById(R.id.pcomplaintenantnamelay);
        complaintsend = (ScrollView) findViewById(R.id.playoutcomplaintsend);
        txtcomplainspinner = (TextView) findViewById(R.id.ptxtcomplaintype);
        listViewcompint = (ListView) findViewById(R.id.plistshowcomplaint);
        txttenantname = (TextView) findViewById(R.id.ptxtcomptenantname);
        btnsendcomplain = (Button) findViewById(R.id.psubmit_complaintbtn);
        backarrow = (RelativeLayout) findViewById(R.id.pback_button_lefttcomp);
        btnviewcomplaint = (RelativeLayout) findViewById(R.id.pbtn_headericoncomplaint);
        editcomplain = (EditText) findViewById(R.id.pcomplaintmsg);
        titlename = (TextView) findViewById(R.id.ptexttitle);
        ...
        titlename.setText("Feedback List");
        btnsendcomplain.setText(" Send Feedback ");
        new GetParentComplaintList().execute();
        ...
        listViewcompint.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Parent_Feedback_Activity.this, Parent_Feedback_Chat_Activity.class);
                intent.putExtra("FeedbackId", arraylistdetail.get(position).getComplaint_id());
    ...
    public void yeardialogMethod() {
        complaintype = new Dialog(Parent_Feedback_Activity.this);
        ...
        Month_Custom_List adapter_data_month = new Month_Custom_List(Parent_Feedback_Activity.this, complain);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.pcomplainnamelayout:

                yeardialogMethod();

                break;

            case R.id.pcomplaintenantnamelay:

                studentdatadialogMethod();

                break;

            case R.id.psubmit_complaintbtn:

                sendtoserver();

                break;

            case R.id.pback_button_lefttcomp:

                // finish();
                Intent ii = new Intent(Parent_Feedback_Activity.this, HostelListActivity.class);
                startActivity(ii);
                //hideSoftKeyboard(this);
                break;

            case R.id.pbtn_headericoncomplaint:
    ...
    private void studentdatadialogMethod() {
        ...
        month_dialog = new Dialog(Parent_Feedback_Activity.this);
        ...
        if (NetworkConnection.isConnected(Parent_Feedback_Activity.this)) {
    ...
    public class SendComplaint extends AsyncTask<String, String, String> {
        ...
        String wid;
        private ProgressDialog dialog = new ProgressDialog(Parent_Feedback_Activity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            listNameValuePairs.add(new BasicNameValuePair("action", "parent_feedback"));
            ...
            if (result == null) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("Y")) {
                        ...
                        Intent ii = new Intent(Parent_Feedback_Activity.this, HostelListActivity.class);
                        ii.putExtra("useridvalue", useridvalue);
                        ii.putExtra("parentvalueid", parentvalueid);
                        startActivity(ii);
                        hideSoftKeyboard(Parent_Feedback_Activity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("Y")) {
                if (ownerstudentarraylist.size() > 0) {
                    OwnerStudentNameTanentAdapter adapter_student = new OwnerStudentNameTanentAdapter(Parent_Feedback_Activity.this, ownerstudentarraylist);
                    student_list_dialog.setAdapter(adapter_student);
                }
            } else if (result.equalsIgnoreCase("N")) {
                Toast.makeText(Parent_Feedback_Activity.this, "No Tanent Found", Toast.LENGTH_LONG).show();
            }
        }
    }

    //this class is used to get parent compliant list send by owner/tenant
    public class GetParentComplaintList extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            ArrayList<NameValuePair> listNameValuePairs;
            listNameValuePairs = new ArrayList<NameValuePair>();
            listNameValuePairs.add(new BasicNameValuePair("action", "getparentfeedbacklist"));
            //property id paramente not used when getparentcomplaint list from php end this api is getting data by useing parent id
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("Y")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            commodel.setComplaint_id(jsonObject.getString("feedback_id"));
                        ...
                        for (int j = 0; j < jsonArraycount.length(); j++) {
                            ...
                            tmodel.setTcomplaint_id(jsonObject1.getString("feedback_id"));
                        ...
                        listviewshowcomplaintadapter = new ListShowParentfeedbackAdapter(context, arraylistdetailnew);
