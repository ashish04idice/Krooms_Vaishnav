...
public class ListAdapter extends BaseAdapter {
    ...
    public ListAdapter(Activity context, ArrayList<Data_Model> data_model_arraylist, String property_id_value, String user_id_value, String holduserstatus) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        TextView editmodeva;
        {
            ...
            if (holduserstatus.equals("1")) {
                ...
                editmaode.setVisibility(View.VISIBLE);
            }
            ...
            if (!mode.getText().toString().equals("")) {
                mode_option.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String newmonthid = monthid.getText().toString();
                        Intent intent = new Intent(context, ShowMonthDetailOwner.class);
                        intent.putExtra("month", newmonthvalue);
                        intent.putExtra("tanentuserid", user_id_value);
