...
import com.krooms.hostel.rental.property.app.adapter.OwnerFeedbackListAdapter;
...
public class Owner_Feedback_Activity extends AppCompatActivity implements View.OnClickListener {

    String value = "true";
    RelativeLayout backarrow, btnsendComplaint;
    ListView listView;
    public OwnerFeedbackListAdapter ownerFeedbackListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Owner_Feedback_Activity.this, Owner_Feedback_Chat_Activity.class);
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent ii = new Intent(Owner_Feedback_Activity.this, HostelListActivity.class);
                startActivity(ii);
    ...
    private void GetTenantName() {
        ...
        Tenantnamedailog = new Dialog(Owner_Feedback_Activity.this);
        ...
        if (NetworkConnection.isConnected(Owner_Feedback_Activity.this)) {
    ...
    public void getFeedbackheadDialog() {
        complaintype = new Dialog(Owner_Feedback_Activity.this);
        ...
        Month_Custom_List adapter_data_month = new Month_Custom_List(Owner_Feedback_Activity.this, complaint);
    ...
    public class GetTenantComplaint extends AsyncTask<String, String, String> {
        ...
        private ProgressDialog dialog = new ProgressDialog(Owner_Feedback_Activity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            listNameValuePairs.add(new BasicNameValuePair("action", "getownerfeedbacklist"));
...
//
                    if (status.equalsIgnoreCase("Y")) {
                        ...
                        ownerFeedbackListAdapter = new OwnerFeedbackListAdapter(lcontext, arraylistdetail, arraylistdetailnew);
                        listView.setAdapter(ownerFeedbackListAdapter);
                        ownerFeedbackListAdapter.notifyDataSetChanged();
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("true")) {
                if (ownerstudentarraylist.size() > 0) {
                    ...
                    adapter_data_month = new OwnerStudentNameTanentAdapter(Owner_Feedback_Activity.this, ownerstudentarraylist);
                    student_list_dialog.setAdapter(adapter_data_month);
                }
            } else if (result.equalsIgnoreCase("false")) {
                Toast.makeText(Owner_Feedback_Activity.this, "No Tanent Found", Toast.LENGTH_LONG).show();
            }
    ...
    private class SendOwnerFeedback extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            ArrayList<NameValuePair> listNameValuePairs;
            listNameValuePairs = new ArrayList<NameValuePair>();
            listNameValuePairs.add(new BasicNameValuePair("action", "owner_feedback"));
            ...
            if (result == null) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("Y")) {
                        ...
                        Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_SHORT).show();
                        Intent ii = new Intent(Owner_Feedback_Activity.this, Owner_Feedback_Activity.class);
                        ii.putExtra("Ownerid", propertyownerid);
                        ii.putExtra("Propertyid", propertyidvalue_new);
                        startActivity(ii);
                        hideSoftKeyboard(Owner_Feedback_Activity.this);
