...
/**
 * Created by Raghveer on 10-02-2017.
 */
public class ParentComplaintChatAdapter extends BaseAdapter {

    ArrayList<OwnerChatmodel> mainarraylist;
    private Activity context;
    public ParentComplaintChatAdapter(Activity context, ArrayList<OwnerChatmodel> mainarraylist) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        else
        {
            ...
            name=(TextView)rowView.findViewById(R.id.name);
            name.setText(mainarraylist.get(position).getDescription());
            mainname.setText("Child-"+mainarraylist.get(position).getParenttenantname());
        }
