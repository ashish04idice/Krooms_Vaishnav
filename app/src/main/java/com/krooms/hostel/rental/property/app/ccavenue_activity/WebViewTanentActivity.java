...
public class WebViewTanentActivity extends Activity {
    ...
    private class RenderView extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(WebViewTanentActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            class MyJavaScriptInterface {
                ...
                public void processHTML(String html) {
                    ...
                    String tenantid = PaymentActivityTanent.tenant_id_value_new;
                    String userid = PaymentActivityTanent.useridvalue;
                    String roomid = PaymentActivityTanent.roomid_value;
                    String propertyid = PaymentActivityTanent.bookedpropertyidvalue;
            ...
            params.append(ServiceUtility.addToPostParams(AvenuesParams.MERCHANT_PARAM6, PaymentActivityTanent.tenant_id_value_new));
...
//					finish();
    ...
    private class PaymentActivityOwnerJSONParse extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("owner_id", PaymentActivityTanent.ownerid_value));
                nameValuePairs.add(new BasicNameValuePair("user_id", PaymentActivityTanent.useridvalue));
                nameValuePairs.add(new BasicNameValuePair("tenant_id", PaymentActivityTanent.tenant_id_value_new));
                nameValuePairs.add(new BasicNameValuePair("month_id", PaymentActivityTanent.monthid));
                nameValuePairs.add(new BasicNameValuePair("year", PaymentActivityTanent.yearvaluet));
                nameValuePairs.add(new BasicNameValuePair("month_name", PaymentActivityTanent.monthV));
                nameValuePairs.add(new BasicNameValuePair("amount", PaymentActivityTanent.totalAmount_value));
                nameValuePairs.add(new BasicNameValuePair("room_id", PaymentActivityTanent.roomid_value));
                nameValuePairs.add(new BasicNameValuePair("property_id", PaymentActivityTanent.bookedpropertyidvalue));
                nameValuePairs.add(new BasicNameValuePair("current_date", PaymentActivityTanent.currentdate_value));
                nameValuePairs.add(new BasicNameValuePair("advance_amount", PaymentActivityTanent.advanceamountvalue));
                nameValuePairs.add(new BasicNameValuePair("room_amount", PaymentActivityTanent.roomamountva));
        ...
        protected void onPostExecute(String result) {
            ...
            if (!IsError) {
                if (result.equalsIgnoreCase("Y")) {
                    ...
                    Successdialog();
                    Toast.makeText(WebViewTanentActivity.this, "Payment is successfull", Toast.LENGTH_LONG).show();

                } else if (result.equals("N")) {
                    Toast.makeText(WebViewTanentActivity.this, message, Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(WebViewTanentActivity.this, "please check network connection", Toast.LENGTH_LONG).show();
            }
    ...
    public void Successdialog() {
        Dialog successdialog = new Dialog(WebViewTanentActivity.this);
        ...
        download_data_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(WebViewTanentActivity.this, PDFFileNewPage_Tanentform.class);
                i.putExtra("name", PaymentActivityTanent.tanentname);
                i.putExtra("date", PaymentActivityTanent.currentdate_value1);
                i.putExtra("month", PaymentActivityTanent.monthV);
                i.putExtra("uid", PaymentActivityTanent.useridvalue);
                i.putExtra("amount", PaymentActivityTanent.amountV);
                i.putExtra("keyid", PaymentActivityTanent.keyidtenant);
                i.putExtra("roomno", PaymentActivityTanent.roomnotenant);
                i.putExtra("property_id", PaymentActivityTanent.Bookedpropertykeyid);
                i.putExtra("propertyname", mSharedStorage.getPropertyname());
                i.putExtra("mode", "Online");
                startActivity(i);
            }
        });
        username.setText(PaymentActivityTanent.tanentname);
        userdate.setText(PaymentActivityTanent.currentdate_value1);
        paymentmonth.setText(PaymentActivityTanent.monthV);
        userpaid.setText(PaymentActivityTanent.totalAmount_value);
        userpid.setText(PaymentActivityTanent.Bookedpropertykeyid);
        usertid.setText(PaymentActivityTanent.keyidtenant);
        userroomno.setText(PaymentActivityTanent.roomnotenant);
        propertyname.setText(mSharedStorage.getPropertyname());
        usermode.setText("Online");
        nobutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(WebViewTanentActivity.this, TanentactivityFrom.class);
                startActivity(i);
            }
        });
    ...
    public class GetTransactionTablePaymentStatus extends AsyncTask<String, String, String> {
        ...
        private ProgressDialog dialog = new ProgressDialog(WebViewTanentActivity.this);
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (pstatus.equalsIgnoreCase("success") || pstatus.equalsIgnoreCase("Successful") || pstatus.equalsIgnoreCase("successfully") || pstatus.equalsIgnoreCase("Panding")) {
                                ...
                                Toast.makeText(WebViewTanentActivity.this, "Your transaction is failed! please try again", Toast.LENGTH_LONG).show();
