...
public class ListShowParentcomplaintAdapter extends BaseAdapter {
    ...
    public ListShowParentcomplaintAdapter(Context lcontext, ArrayList<Complaintdetailtenantnew> arraylistdetailnew, ArrayList<Tenant_Complaintcountmodel> countarray) {
