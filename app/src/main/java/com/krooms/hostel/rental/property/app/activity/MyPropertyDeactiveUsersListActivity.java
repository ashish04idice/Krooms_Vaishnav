...
import com.krooms.hostel.rental.property.app.adapter.MyDeactiveUserListAdapter;
...
public class MyPropertyDeactiveUsersListActivity extends FragmentActivity implements ServiceResponce, View.OnClickListener {
    ...
    private MyDeactiveUserListAdapter mAdapterBookedUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_my_property_list_booked_deactive);
        Intent in = getIntent();
    ...
    public void callWebServiceBookedUser() {
        ...
        if (mValidation.checkNetworkRechability()) {
            ...
            serviceAsyncTask.setCallBack(MyPropertyDeactiveUsersListActivity.this);
        ...
        try {
            ...
            if (status.equals("true")) {
                ...
                for (int i = 0; i < jsoArray.length(); i++) {
                    ...
                    if (statusbooking.equals("0") && statuactivate.equals("deactive")) {
                ...
                mAdapterBookedUser = new MyDeactiveUserListAdapter(mActivity, mArrayBookedUser);
...
//                finish();
                startActivity(new Intent(MyPropertyDeactiveUsersListActivity.this, HostelListActivity.class));
                break;
