 ...
 */
public class BillingShippingParentActivity extends Activity {
    ...
    public void onClick(View view) {
        ...
        if (selectedCardType != null && selectedPaymentOption != null && !vOrderId.equals("") && !vRsaKeyUrl.equals("")) {
            Intent intent = new Intent(this, WebViewParentActivity.class);
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(BillingShippingParentActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                PayOptAdapter payOptAdapter = new PayOptAdapter(BillingShippingParentActivity.this, android.R.layout.simple_spinner_item, payOptionList);
...
//							((LinearLayout) findViewById(R.id.cardDetails)).setVisibility(View.VISIBLE);
                            ...
                            EMIAdapter emiAdapter = new EMIAdapter(BillingShippingParentActivity.this, android.R.layout.simple_spinner_item, emiOptionList);
                            ...
                            emiOption.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                ...
                                public void onItemSelected(AdapterView parent, View view, int position, long id) {
                                    ...
                                    CardNameAdapter cardNameAdapter = new CardNameAdapter(BillingShippingParentActivity.this, android.R.layout.simple_spinner_item, cardNameList);
                                    ...
                                    RadioGroup rg = new RadioGroup(BillingShippingParentActivity.this);
                                    rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                                        public void onCheckedChanged(RadioGroup group, int checkedId) {
                                            try {
                                                ...
                                                TextView vProcFee = new TextView(BillingShippingParentActivity.this);
                                    ...
                                    while (vEmiPlanIt.hasNext()) {
                                        ...
                                        RadioButton rb = new RadioButton(BillingShippingParentActivity.this);
                            ...
                            CardAdapter cardTypeAdapter = new CardAdapter(BillingShippingParentActivity.this, android.R.layout.simple_spinner_item, cardsList.get(selectedPaymentOption));
                    ...
                    if (jsonRespObj != null) {
                        if (jsonRespObj.getString("CustPayments") != null) {
                            ...
                            if (vJsonArr.length() > 0) {
                                ...
                                final LinearLayout vVaultOptionsCont = new LinearLayout(BillingShippingParentActivity.this);
                                vVaultOptionsCont.setId(R.id.vaultCont);
                                vVaultOptionsCont.setOrientation(LinearLayout.VERTICAL);
                                TextView tv = new TextView(BillingShippingParentActivity.this);
                                ...
                                final CheckBox vChb = new CheckBox(BillingShippingParentActivity.this);
    ...
    private class PaymentActivityOwnerJSONParse extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("property_id", PaymentActivityParent.propertyid_value));
        ...
        protected void onPostExecute(String result) {
            ...
            if (!IsError) {
                if (result.equalsIgnoreCase("Y")) {
                    ...
                    Toast.makeText(BillingShippingParentActivity.this, "Payment is successfull", Toast.LENGTH_LONG).show();

                } else if (result.equals("N")) {
                    Toast.makeText(BillingShippingParentActivity.this, message, Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(BillingShippingParentActivity.this, "please check network connection", Toast.LENGTH_LONG).show();
            }
