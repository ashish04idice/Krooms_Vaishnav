...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "IdiceDB";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //  db.execSQL("CREATE TABLE IF NOT EXISTS persons_image(id INTEGER PRIMARY KEY AUTOINCREMENT,tenantid VARCHAR,propertyid VARCHAR,bitmap VARCHAR,status VARCHAR);");
