...
import com.krooms.hostel.rental.property.app.adapter.ParentComplaintChatAdapter;
 ...
 */
public class Parent_Feedback_Chat_Activity extends AppCompatActivity {
    ...
    String PropertyId, OwnerId, FeedbackId, TenantId, TenantName, UserId, Date, ParentId, WardenId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FeedbackId = ii.getStringExtra("FeedbackId");
        ...
        new GetParentSeen().execute();

        backarrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent i = new Intent(Parent_Feedback_Chat_Activity.this, Parent_Feedback_Activity.class);
                i.putExtra("parentvalueid", ParentId);
                startActivity(i);
        ...
        sendreply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (descriptionvalue.equals("")) {
                    ...
                    Toast.makeText(Parent_Feedback_Chat_Activity.this, "please enter description", Toast.LENGTH_SHORT).show();
    ...
    public class getEventdataJsonCalss extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(Parent_Feedback_Chat_Activity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("feedback_id", FeedbackId));
                ...
                if (result.equals("Y")) {
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                        ...
                        evnentmodel.setParenttenantname(jsonobj.getString("tenant_name"));
        ...
        protected void onPostExecute(String th) {
            ...
            if (!IsError) {
                if (result.equals("Y")) {
                    ParentComplaintChatAdapter adapter = new ParentComplaintChatAdapter(Parent_Feedback_Chat_Activity.this, mainarraylist);
                    listView.setAdapter(adapter);
                } else {
                    Toast.makeText(Parent_Feedback_Chat_Activity.this, message, Toast.LENGTH_SHORT).show();
                }
    ...
    public class SendComplaintJsonCalss extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(10);
                nameValuePairs.add(new BasicNameValuePair("action", "parent_feedback_reply"));
                nameValuePairs.add(new BasicNameValuePair("property_id", PropertyId));
                nameValuePairs.add(new BasicNameValuePair("owner_id", OwnerId));
                nameValuePairs.add(new BasicNameValuePair("feedback_id", FeedbackId));
        ...
        protected void onPostExecute(String th) {
            ...
            if (!IsError) {
                ...
                Toast.makeText(Parent_Feedback_Chat_Activity.this, "" + message, Toast.LENGTH_SHORT).show();
                description.setText("");
                Intent i = new Intent(Parent_Feedback_Chat_Activity.this, Parent_Feedback_Chat_Activity.class);
                i.putExtra("FeedbackId", FeedbackId);
...
//
    ...
    //Parent seen message
    public class GetParentSeen extends AsyncTask<String, String, String> {

        private ProgressDialog dialog = new ProgressDialog(Parent_Feedback_Chat_Activity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            listNameValuePairs.add(new BasicNameValuePair("action", "parent_feedback_read_msg"));
            listNameValuePairs.add(new BasicNameValuePair("feedback_id", FeedbackId));
