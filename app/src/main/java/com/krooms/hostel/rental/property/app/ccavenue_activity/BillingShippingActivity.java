...
public class BillingShippingActivity extends Activity {
    ...
    public void onClick(View view) {
        ...
        if (selectedCardType != null && selectedPaymentOption != null && !vOrderId.equals("") && !vRsaKeyUrl.equals("")) {
            ...
            intent.putExtra(AvenuesParams.ROOM_AMOUNT, mainIntent.getStringExtra(AvenuesParams.ROOM_AMOUNT));
            ...
            intent.putExtra(AvenuesParams.TRANSACTION_FOR, "BOOKING");
            intent.putExtra(AvenuesParams.comment, mainIntent.getStringExtra(AvenuesParams.comment));//
