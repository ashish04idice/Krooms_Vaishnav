...
public class Payment_Paid_Unpaid_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (NetworkConnection.isConnected(Payment_Paid_Unpaid_Activity.this)) {
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mShared.getUserType().equals("5")) {
                    startActivity(new Intent(Payment_Paid_Unpaid_Activity.this, Home_Accountantactivity.class));
                } else {
                    Intent i = new Intent(Payment_Paid_Unpaid_Activity.this, Owner_Paid_Unpaid_Selection_Activity.class);
    ...
    private void GetPaidRecord() {
        ...
        final ProgressDialog dialog = new ProgressDialog(Payment_Paid_Unpaid_Activity.this);
        ...
        try {
            ...
            params.put("action", "paiduserlist");
        ...
        try {
            ...
            if (status.equalsIgnoreCase("Y")) {
                ...
                for (int i = 0; i < jsonarray.length(); i++) {
                    ...
                    recordmodel.setPaydate(jsonobj.getString("transaction_date"));
                ...
                adapter = new Payment_Paid_Unpaid_Adapter(Payment_Paid_Unpaid_Activity.this, arraylistpaid);
                list_paid.setAdapter(adapter);
                adapter.notifyDataSetChanged();

            } else {
                Toast.makeText(Payment_Paid_Unpaid_Activity.this, message, Toast.LENGTH_SHORT).show();
            }
    ...
    private void GetUnPaidRecord() {
        ...
        try {
            JSONObject params = new JSONObject();
            params.put("action", "unpaiduserlist");
            params.put("property_id", propertyid);
            params.put("month_id", month_id);
            params.put("year", year1);
            String url = WebUrls.MAIN_URL;
    ...
    public void getUnpaidResponseData(String result) {
        try {
            ...
            if (status.equalsIgnoreCase("Y")) {
                ...
                adapter = new Payment_Paid_Unpaid_Adapter(Payment_Paid_Unpaid_Activity.this, arraylistunpaid);
