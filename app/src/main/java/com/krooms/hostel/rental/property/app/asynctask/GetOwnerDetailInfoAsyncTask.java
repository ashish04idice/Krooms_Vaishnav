 ...
 */
public class GetOwnerDetailInfoAsyncTask  extends AsyncTask<String, Void, String> {
    ...
    public GetOwnerDetailInfoAsyncTask(Activity activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            locationData.put("action", "getPropertyOwnerInfo");
