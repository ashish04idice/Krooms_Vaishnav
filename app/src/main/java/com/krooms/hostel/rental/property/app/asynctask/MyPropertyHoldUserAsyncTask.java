 ...
 */
public class MyPropertyHoldUserAsyncTask extends AsyncTask<String, Void, String> {
    ...
    public MyPropertyHoldUserAsyncTask(Activity activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            locationData.put("action", "userListOfAHoldTenant");
