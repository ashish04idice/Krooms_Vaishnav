 ...
 */
public class GetOwnerDetailServiceAsyncTask extends AsyncTask<String, Void, String> {
    ...
    public GetOwnerDetailServiceAsyncTask(Activity activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            locationData.put("action","getownerdetails");
