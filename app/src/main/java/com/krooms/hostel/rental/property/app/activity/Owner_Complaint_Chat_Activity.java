 ...
 */
public class Owner_Complaint_Chat_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Owner_Complaint_Chat_Activity.this, Owner_Complaint_Activity.class);
        ...
        sendreply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (descriptionvalue.equals("")) {
                    ...
                    Toast.makeText(Owner_Complaint_Chat_Activity.this, "please enter description", Toast.LENGTH_SHORT).show();
        ...
        if (!ComplaintId.equals("")) {
            ...
            Toast.makeText(Owner_Complaint_Chat_Activity.this, "complaint id is null", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public class getEventdataJsonCalss extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(Owner_Complaint_Chat_Activity.this);
        ...
        protected void onPostExecute(String th) {
            ...
            if (!IsError) {
                if (result.equals("Y")) {
                    OwnerComplaintChatAdapter adapter = new OwnerComplaintChatAdapter(Owner_Complaint_Chat_Activity.this, mainarraylist);
                    listView.setAdapter(adapter);
                } else {
                    Toast.makeText(Owner_Complaint_Chat_Activity.this, message, Toast.LENGTH_SHORT).show();
                }
    ...
    public class SendComplaintJsonCalss extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                listNameValuePairs.add(new BasicNameValuePair("action", "owner_complain_reply"));
        ...
        protected void onPostExecute(String th) {
            ...
            if (result.equals("Y")) {
                ...
                Intent i = new Intent(Owner_Complaint_Chat_Activity.this, Owner_Complaint_Chat_Activity.class);
    ...
    public class GetOwnerSeen extends AsyncTask<String, String, String> {
        ...
        private ProgressDialog dialog = new ProgressDialog(Owner_Complaint_Chat_Activity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            listNameValuePairs.add(new BasicNameValuePair("action", "owne_read_msg"));
            listNameValuePairs.add(new BasicNameValuePair("complain_id", ComplaintId));
