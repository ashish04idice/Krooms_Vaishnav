 ...
 */
public class SearchPropertyListMapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public SearchPropertyListMapFragment() {
    }

    public void getPerameter(ArrayList<PropertyModal> list) {
        ...
        this.mMap.setOnMyLocationChangeListener(new GoogleMap.OnMyLocationChangeListener() {
            ...
            public void onMyLocationChange(Location location) {
                ...
                if (!isGotMyLocation) {
                    ...
                    SearchPropertyListMapFragment.this.mMap.animateCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
