...
public class Attandance_Scanner_Selection_Activity extends Activity {
    ...
    String currentDateandTime = "", urlname = "", versionCode = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backarraow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ii = new Intent(Attandance_Scanner_Selection_Activity.this, HostelListActivity.class);
                startActivity(ii);
            }
        });
        ...
        btn_secugen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedRadioButtonID != -1) {
                    ...
                    if (NetworkConnection.isConnected(Attandance_Scanner_Selection_Activity.this)) {
                        RadioButton selectedRadioButton = (RadioButton) findViewById(selectedRadioButtonID);
                        String selectedRadioButtonText = selectedRadioButton.getText().toString();
                        getVersionDevice();
                        String device_name = "Secugen";
                        Utility.setSharedPreference(Attandance_Scanner_Selection_Activity.this, "deviceMode", selectedRadioButtonText);
        ...
        btn_startak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (NetworkConnection.isConnected(Attandance_Scanner_Selection_Activity.this)) {
                    Intent ii = new Intent(Attandance_Scanner_Selection_Activity.this, Get_Attendance_Startek.class);
    ...
    private void getVersionDevice() {
        ...
        try {
            info = manager.getPackageInfo(Attandance_Scanner_Selection_Activity.this.getPackageName(), 0);
    ...
    private void sendDeviceInfoSecugen(String propertyid, String urlname, String currentDateandTime, String selectedRadioButtonText, String device_name) {
        ...
        final ProgressDialog dialog = new ProgressDialog(Attandance_Scanner_Selection_Activity.this);
    ...
    public void getResponseDataSecugen(String result) {
        try {
            ...
            if (status.equalsIgnoreCase("Y")) {
                Intent ii = new Intent(Attandance_Scanner_Selection_Activity.this, Tenant_Details_Activity.class);
                ii.putExtra("propertyid", propertyid);
