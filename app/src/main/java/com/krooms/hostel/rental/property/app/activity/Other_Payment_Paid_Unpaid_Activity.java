...
public class Other_Payment_Paid_Unpaid_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (NetworkConnection.isConnected(Other_Payment_Paid_Unpaid_Activity.this)) {
            GetPaidRecord();
        } else {
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mShared.getUserType().equals("5")) {
                    startActivity(new Intent(Other_Payment_Paid_Unpaid_Activity.this, Home_Accountantactivity.class));
                } else {
                    Intent i = new Intent(Other_Payment_Paid_Unpaid_Activity.this, Owner_Paid_Unpaid_Selection_Activity.class);
    ...
    private void GetPaidRecord() {
        ...
        final ProgressDialog dialog = new ProgressDialog(Other_Payment_Paid_Unpaid_Activity.this);
        ...
        try {
            ...
            params.put("action", "otherchargepaiduserlist");
    ...
    public void getResponseData(String result) {
        try {
            ...
            if (status.equalsIgnoreCase("Y")) {
                ...
                Toast.makeText(Other_Payment_Paid_Unpaid_Activity.this, message, Toast.LENGTH_SHORT).show();
                adapter = new Payment_Paid_Unpaid_Adapter(Other_Payment_Paid_Unpaid_Activity.this, arraylistpaid);
    ...
    private void GetUnPaidRecord() {
        ...
        try {
            JSONObject params = new JSONObject();
            params.put("action", "otherchargeunpaiduserlist");
            params.put("property_id", propertyid);
            params.put("month_id", month_id);
            params.put("year", year1);
            String url = WebUrls.MAIN_URL;
        ...
        try {
            ...
            if (status.equalsIgnoreCase("Y")) {
                ...
                for (int i = 0; i < jsonarray.length(); i++) {
                    ...
                    String unpaidtotalnew = jsonobj.getString("total_amount");

                    if (unpaidtotalnew.equals("") || unpaidtotalnew.equals(null) || unpaidtotalnew.equals("null")) {


                    } else {
                        unpaidtotal = Integer.parseInt(jsonobj.getString("total_amount"));
                ...
                adapter = new Payment_Paid_Unpaid_Adapter(Other_Payment_Paid_Unpaid_Activity.this, arraylistunpaid);
