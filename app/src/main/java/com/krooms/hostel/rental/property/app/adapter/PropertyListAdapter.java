...
public class PropertyListAdapter extends BaseAdapter {
    ...
    public PropertyListAdapter(Activity context, HashMap<String, ArrayList<PropertyModal>> objects) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        if (null == convertView) {
            convertView = inflater.inflate(R.layout.property_list_item, null);
        }
        ...
        pager.setAdapter(new CustomPagerAdapter(activity, list.get(titleArray[PropertyListFragment.propertyListIndex.get(position)])));
