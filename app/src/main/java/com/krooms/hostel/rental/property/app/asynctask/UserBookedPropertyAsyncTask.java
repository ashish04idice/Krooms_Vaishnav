 ...
 */
public class UserBookedPropertyAsyncTask extends AsyncTask<String, Void, String> {
    ...
    public UserBookedPropertyAsyncTask(Activity activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            locationData.put("action", "myBookedProperty");
