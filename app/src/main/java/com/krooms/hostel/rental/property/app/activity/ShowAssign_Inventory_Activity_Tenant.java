...
import com.krooms.hostel.rental.property.app.adapter.ShowAssignInventory_Adapter_Tenant;
 ...
 */
public class ShowAssign_Inventory_Activity_Tenant extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.showinventory_activity_layout_tenant);
        in=getIntent();
    ...
    public class getAssignitemlist extends AsyncTask<String, String, String> {
        ...
        private ProgressDialog dialog = new ProgressDialog(ShowAssign_Inventory_Activity_Tenant.this);
                    ...
                    if (status.equalsIgnoreCase("Y")) {
                       ...
                       // JSONArray jsonArraycount = obj.getJSONArray("record");
                        ...
                        if (showinventory_arraylist.size() > 0) {
                            ...
                            ShowAssignInventory_Adapter_Tenant adapter_data_month = new ShowAssignInventory_Adapter_Tenant(ShowAssign_Inventory_Activity_Tenant.this,showinventory_arraylist,tenantidvalue,propertyid);
                            showinventoerylist.setAdapter(adapter_data_month);
                        }
                     else if (result.equalsIgnoreCase("N")) {
                        Toast.makeText(ShowAssign_Inventory_Activity_Tenant.this, "Iteam Is Not Assign", Toast.LENGTH_LONG).show();
                        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode)
        {
            case KeyEvent.KEYCODE_BACK:
                ...
                startActivity(new Intent(ShowAssign_Inventory_Activity_Tenant.this,HostelListActivity.class));
