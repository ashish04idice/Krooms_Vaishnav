...
public class BillingShippingOwnerActivity extends Activity {
    ...
    public void onClick(View view) {
        ...
        if (selectedCardType != null && selectedPaymentOption != null && !vOrderId.equals("") && !vRsaKeyUrl.equals("")) {
            Intent intent = new Intent(this, WebViewOwnerActivity.class);
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(BillingShippingOwnerActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                PayOptAdapter payOptAdapter = new PayOptAdapter(BillingShippingOwnerActivity.this, android.R.layout.simple_spinner_item, payOptionList);
...
//							((LinearLayout) findViewById(R.id.cardDetails)).setVisibility(View.VISIBLE);
                            ...
                            EMIAdapter emiAdapter = new EMIAdapter(BillingShippingOwnerActivity.this, android.R.layout.simple_spinner_item, emiOptionList);
                            ...
                            emiOption.setOnItemSelectedListener(new OnItemSelectedListener() {
                                ...
                                public void onItemSelected(AdapterView parent, View view, int position, long id) {
                                    ...
                                    CardNameAdapter cardNameAdapter = new CardNameAdapter(BillingShippingOwnerActivity.this, android.R.layout.simple_spinner_item, cardNameList);
                                    ...
                                    RadioGroup rg = new RadioGroup(BillingShippingOwnerActivity.this);
                                    rg.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                                        public void onCheckedChanged(RadioGroup group, int checkedId) {
                                            try {
                                                ...
                                                TextView vProcFee = new TextView(BillingShippingOwnerActivity.this);
                                    ...
                                    while (vEmiPlanIt.hasNext()) {
                                        ...
                                        RadioButton rb = new RadioButton(BillingShippingOwnerActivity.this);
                            ...
                            CardAdapter cardTypeAdapter = new CardAdapter(BillingShippingOwnerActivity.this, android.R.layout.simple_spinner_item, cardsList.get(selectedPaymentOption));
                    ...
                    if (jsonRespObj != null) {
                        if (jsonRespObj.getString("CustPayments") != null) {
                            ...
                            if (vJsonArr.length() > 0) {
                                ...
                                final LinearLayout vVaultOptionsCont = new LinearLayout(BillingShippingOwnerActivity.this);
                                vVaultOptionsCont.setId(R.id.vaultCont);
                                vVaultOptionsCont.setOrientation(LinearLayout.VERTICAL);
                                TextView tv = new TextView(BillingShippingOwnerActivity.this);
                                ...
                                final CheckBox vChb = new CheckBox(BillingShippingOwnerActivity.this);
...
//								ll.setVisibility(View.VISIBLE);
    ...
    private class PaymentActivityOwnerJSONParse extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (!IsError) {
                if (result.equalsIgnoreCase("Y")) {
                    Toast.makeText(BillingShippingOwnerActivity.this, "Payment is successfull", Toast.LENGTH_LONG).show();

                } else if (result.equals("N")) {
                    Toast.makeText(BillingShippingOwnerActivity.this, "Failure", Toast.LENGTH_LONG).show();
                }
            }
        }
    }
