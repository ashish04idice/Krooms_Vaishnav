...
public class Electricity_Paid_Unpaid_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.payment_paid_unpaid_layout);
        context = this;
        ...
        month_id = splited[1];
        year1 = splited[2];
        if (NetworkConnection.isConnected(Electricity_Paid_Unpaid_Activity.this)) {
            GetPaidRecord();
        } else {
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mShared.getUserType().equals("5")) {
                    startActivity(new Intent(Electricity_Paid_Unpaid_Activity.this, Home_Accountantactivity.class));
                } else {
                    Intent i = new Intent(Electricity_Paid_Unpaid_Activity.this, Owner_Paid_Unpaid_Selection_Activity.class);
    ...
    private void GetPaidRecord() {
        ...
        final ProgressDialog dialog = new ProgressDialog(Electricity_Paid_Unpaid_Activity.this);
        ...
        try {
            ...
            params.put("action", "paiduserlistelectricity");
        ...
        try {
            ...
            if (status.equalsIgnoreCase("Y")) {
                ...
                for (int i = 0; i < jsonarray.length(); i++) {
                    ...
                    String transdate = jsonobj.getString("transdate");
                    if (transdate.equals("") || transdate.equals(null) || transdate.equals("null")) {

                        recordmodel.setPaydate(" ");

                    } else {
                        recordmodel.setPaydate(jsonobj.getString("transdate"));
                    }

                    String tpaid = jsonobj.getString("paid_amount");
                    ...
                    if (tpaid.equals("") || tpaid.equals(null) || tpaid.equals("null")) {
                        ...
                        recordmodel.setPaid(jsonobj.getString("paid_amount"));
                    }

                    String paidtotalnew = jsonobj.getString("amount");

                    if (paidtotalnew.equals("") || paidtotalnew.equals(null) || paidtotalnew.equals("null")) {

                    } else {
                        ptotal = Integer.parseInt(jsonobj.getString("amount"));
                        sumtotal = sumtotal + ptotal;
                    }
                    // recordmodel.setTotalsum(String.valueOf(sumtotal));

                    String paid = jsonobj.getString("paid_amount");

                    if (paid.equals("") || paid.equals(null) || paid.equals("null")) {

                    } else {
                        paidamount = Integer.parseInt(jsonobj.getString("paid_amount"));
                        sumpaid = sumpaid + paidamount;
                    }
                    //  recordmodel.setTotalpaidsum(String.valueOf(sumpaid));
                ...
                adapter = new Payment_Paid_Unpaid_Adapter(Electricity_Paid_Unpaid_Activity.this, arraylistpaid);
                list_paid.setAdapter(adapter);
                adapter.notifyDataSetChanged();

            } else {
                Toast.makeText(Electricity_Paid_Unpaid_Activity.this, message, Toast.LENGTH_SHORT).show();
            }
    ...
    public void getUnpaidResponseData(String result) {
        try {
            ...
            if (status.equalsIgnoreCase("Y")) {
                ...
                adapter = new Payment_Paid_Unpaid_Adapter(Electricity_Paid_Unpaid_Activity.this, arraylistunpaid);
