 ...
 */
public class TenantComplaintChatAdapter extends BaseAdapter {

    ArrayList<OwnerChatmodel> mainarraylist;
    private Activity context;
    public TenantComplaintChatAdapter(Activity context, ArrayList<OwnerChatmodel> mainarraylist) {
