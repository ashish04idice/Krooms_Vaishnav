...
import com.krooms.hostel.rental.property.app.adapter.TenantFeedbackChatAdapter;
 ...
 */
public class Tenant_Feedback_Chat_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(Tenant_Feedback_Chat_Activity.this,Tenant_Feedback_Activity.class);
                startActivity(i);
        ...
        sendreply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (descriptionvalue.equals("")) {
                    ...
                    Toast.makeText(Tenant_Feedback_Chat_Activity.this, "please enter description", Toast.LENGTH_SHORT).show();
    ...
    public class getEventdataJsonCalss extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd=new ProgressDialog(Tenant_Feedback_Chat_Activity.this);
        ...
        protected void onPostExecute(String th) {
            ...
            {
                if(result.equals("Y")) {
                    TenantFeedbackChatAdapter adapter=new TenantFeedbackChatAdapter(Tenant_Feedback_Chat_Activity.this,mainarraylist);
                    listView.setAdapter(adapter);
                }else
                {
                    Toast.makeText(Tenant_Feedback_Chat_Activity.this,message, Toast.LENGTH_SHORT).show();
                }
    ...
    public class SendComplaintJsonCalss extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(10);
                nameValuePairs.add(new BasicNameValuePair("action","tenant_feedback_reply"));
                nameValuePairs.add(new BasicNameValuePair("property_id",PropertyId));
                nameValuePairs.add(new BasicNameValuePair("owner_id",OwnerId));
                nameValuePairs.add(new BasicNameValuePair("feedback_id",ComplaintId));
        ...
        protected void onPostExecute(String th) {
            ...
            if (!IsError)
            {
                   ...
                   Intent i=new Intent(Tenant_Feedback_Chat_Activity.this,Tenant_Feedback_Chat_Activity.class);
                    i.putExtra("FeedbackId",ComplaintId);
...
//
    ...
    // This class is used to send tenant feedback seen status to server
    public class GetTenantFeedbackSeen extends AsyncTask<String, String, String> {

        private ProgressDialog dialog = new ProgressDialog(Tenant_Feedback_Chat_Activity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            listNameValuePairs.add(new BasicNameValuePair("action","tenant_feedback_read_msg"));
