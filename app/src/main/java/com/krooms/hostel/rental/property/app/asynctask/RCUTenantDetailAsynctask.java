 ...
 */
public class RCUTenantDetailAsynctask extends AsyncTask<String, Integer, String> {
    ...
    public RCUTenantDetailAsynctask(Activity activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            entity.addPart("action","rcu_booking_phase2");
            ...
            entity.addPart("transaction_id",params[22]);
