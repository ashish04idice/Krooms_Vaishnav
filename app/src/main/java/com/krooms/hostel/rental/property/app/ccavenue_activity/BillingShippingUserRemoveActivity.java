...
public class BillingShippingUserRemoveActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_billing_shipping_new);
        mActivity = this;
    ...
    public void onClick(View view) {
        ...
        if (selectedCardType != null && selectedPaymentOption != null && !vOrderId.equals("") && !vRsaKeyUrl.equals("")) {
            Intent intent = new Intent(this, WebViewUserRemoveActivity.class);
            ...
            //new chnages by ashish on  9-8-2018
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(BillingShippingUserRemoveActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                PayOptAdapter payOptAdapter = new PayOptAdapter(BillingShippingUserRemoveActivity.this, android.R.layout.simple_spinner_item, payOptionList);
...
//							((LinearLayout) findViewById(R.id.cardDetails)).setVisibility(View.VISIBLE);
                            ...
                            EMIAdapter emiAdapter = new EMIAdapter(BillingShippingUserRemoveActivity.this, android.R.layout.simple_spinner_item, emiOptionList);
                            ...
                            emiOption.setOnItemSelectedListener(new OnItemSelectedListener() {
                                ...
                                public void onItemSelected(AdapterView parent, View view, int position, long id) {
                                    ...
                                    CardNameAdapter cardNameAdapter = new CardNameAdapter(BillingShippingUserRemoveActivity.this, android.R.layout.simple_spinner_item, cardNameList);
                                    ...
                                    RadioGroup rg = new RadioGroup(BillingShippingUserRemoveActivity.this);
                                    rg.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                                        public void onCheckedChanged(RadioGroup group, int checkedId) {
                                            try {
                                                ...
                                                TextView vProcFee = new TextView(BillingShippingUserRemoveActivity.this);
                                    ...
                                    while (vEmiPlanIt.hasNext()) {
                                        ...
                                        RadioButton rb = new RadioButton(BillingShippingUserRemoveActivity.this);
                            ...
                            CardAdapter cardTypeAdapter = new CardAdapter(BillingShippingUserRemoveActivity.this, android.R.layout.simple_spinner_item, cardsList.get(selectedPaymentOption));
                    ...
                    if (jsonRespObj != null) {
                        if (jsonRespObj.getString("CustPayments") != null) {
                            ...
                            if (vJsonArr.length() > 0) {
                                ...
                                final LinearLayout vVaultOptionsCont = new LinearLayout(BillingShippingUserRemoveActivity.this);
                                vVaultOptionsCont.setId(R.id.vaultCont);
                                vVaultOptionsCont.setOrientation(LinearLayout.VERTICAL);
                                TextView tv = new TextView(BillingShippingUserRemoveActivity.this);
                                ...
                                final CheckBox vChb = new CheckBox(BillingShippingUserRemoveActivity.this);
    ...
    private class PaymentActivityOwnerJSONParse extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                System.out.print("monthid" + PaymentActivityOwner.monthid_value + "currentdate" + PaymentActivityOwner.currentdate_value + "owner id" + mSharedStorage.getUserId() + "user id" + PaymentActivityOwner.tanentusrid_value + "month" + PaymentActivityOwner.month +
                        "amount" + PaymentActivityOwner.payment +
        ...
        protected void onPostExecute(String result) {
            ...
            if (!IsError) {
                if (result.equalsIgnoreCase("Y")) {
                    Toast.makeText(BillingShippingUserRemoveActivity.this, "Payment is successfull", Toast.LENGTH_LONG).show();

                } else if (result.equals("N")) {
                    Toast.makeText(BillingShippingUserRemoveActivity.this, "Failure", Toast.LENGTH_LONG).show();
                }
            }
        }
    }
