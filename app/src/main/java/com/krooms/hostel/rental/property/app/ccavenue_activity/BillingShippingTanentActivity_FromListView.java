...
public class BillingShippingTanentActivity_FromListView extends Activity {
    ...
    public void onClick(View view) {
        ...
        if (selectedCardType != null && selectedPaymentOption != null && !vOrderId.equals("") && !vRsaKeyUrl.equals("")) {
            Intent intent = new Intent(this, WebViewTanentActivity_FromListView.class);
    ...
    private class GetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(BillingShippingTanentActivity_FromListView.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                PayOptAdapter payOptAdapter = new PayOptAdapter(BillingShippingTanentActivity_FromListView.this, android.R.layout.simple_spinner_item, payOptionList);
...
//							((LinearLayout) findViewById(R.id.cardDetails)).setVisibility(View.VISIBLE);
                            ...
                            EMIAdapter emiAdapter = new EMIAdapter(BillingShippingTanentActivity_FromListView.this, android.R.layout.simple_spinner_item, emiOptionList);
                            ...
                            emiOption.setOnItemSelectedListener(new OnItemSelectedListener() {
                                ...
                                public void onItemSelected(AdapterView parent, View view, int position, long id) {
                                    ...
                                    CardNameAdapter cardNameAdapter = new CardNameAdapter(BillingShippingTanentActivity_FromListView.this, android.R.layout.simple_spinner_item, cardNameList);
                                    ...
                                    RadioGroup rg = new RadioGroup(BillingShippingTanentActivity_FromListView.this);
                                    rg.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                                        public void onCheckedChanged(RadioGroup group, int checkedId) {
                                            try {
                                                ...
                                                TextView vProcFee = new TextView(BillingShippingTanentActivity_FromListView.this);
                                    ...
                                    while (vEmiPlanIt.hasNext()) {
                                        ...
                                        RadioButton rb = new RadioButton(BillingShippingTanentActivity_FromListView.this);
                            ...
                            CardAdapter cardTypeAdapter = new CardAdapter(BillingShippingTanentActivity_FromListView.this, android.R.layout.simple_spinner_item, cardsList.get(selectedPaymentOption));
                    ...
                    if (jsonRespObj != null) {
                        if (jsonRespObj.getString("CustPayments") != null) {
                            ...
                            if (vJsonArr.length() > 0) {
                                ...
                                final LinearLayout vVaultOptionsCont = new LinearLayout(BillingShippingTanentActivity_FromListView.this);
                                vVaultOptionsCont.setId(R.id.vaultCont);
                                vVaultOptionsCont.setOrientation(LinearLayout.VERTICAL);
                                TextView tv = new TextView(BillingShippingTanentActivity_FromListView.this);
                                ...
                                final CheckBox vChb = new CheckBox(BillingShippingTanentActivity_FromListView.this);
