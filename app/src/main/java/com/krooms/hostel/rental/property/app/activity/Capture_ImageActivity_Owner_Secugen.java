...
public class Capture_ImageActivity_Owner_Secugen extends Activity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Capture_ImageActivity_Owner_Secugen.this, Finger_Selction_Owner_Activity.class);
    ...
    public void onClick(View v) {
        ...
        if (v == msavebtn) {
            if (!base64uid.equals("") && !fingerindex.equals("") && !propertyid.equals("")) {
                InsertIntoDB(base64uid, fingerindex, propertyid);
            } else {
                Toast.makeText(Capture_ImageActivity_Owner_Secugen.this, "Please Insert all record", Toast.LENGTH_SHORT).show();
            }
        }
    }


    private void InsertIntoDB(String fingerimage, String fingerindex, String propertyid) {

        if (!propertyid.equals("")) {

            try {

                String query1 = "select * from ownerfingerprint where  propertyid='" + propertyid + "' and  thumbindex='" + fingerindex + "'";
                c = db.rawQuery(query1, null);
                if (c.getCount() != 0) {
                    String query2 = null;
                    query2 = "UPDATE ownerfingerprint  set thumbfinger='" + fingerimage + "' where  propertyid='" + propertyid + "' and  thumbindex='" + fingerindex + "';";
                    db.execSQL(query2);
                    new SendRecordtoserver(fingerimage, fingerindex, propertyid).execute();
                   ...
                   /* Intent intent = new Intent(Capture_ImageActivity_Owner_Secugen.this, Finger_Selction_Owner_Activity.class);
                    ...
                    String query = "INSERT INTO ownerfingerprint (propertyid,thumbfinger,thumbindex) VALUES('" + propertyid + "','" + fingerimage + "','" + fingerindex + "')";
                    db.execSQL(query);
                    new SendRecordtoserver(fingerimage, fingerindex, propertyid).execute();
                   // Toast.makeText(getApplicationContext(), "Save successfully", Toast.LENGTH_SHORT).show();
                    /*Intent intent = new Intent(Capture_ImageActivity_Owner_Secugen.this, Finger_Selction_Owner_Activity.class);
    ...
    public class SendRecordtoserver extends AsyncTask<String, String, String> {
        ...
        private ProgressDialog dialog = new ProgressDialog(Capture_ImageActivity_Owner_Secugen.this);
        public SendRecordtoserver(String fingerimage, String fingerindex, String propertyid) {
        ...
        protected String doInBackground(String... params) {
            ...
            listNameValuePairs.add(new BasicNameValuePair("action", "enrollownerattendencerecords"));
            ...
            listNameValuePairs.add(new BasicNameValuePair("device_type", "Secugen"));
