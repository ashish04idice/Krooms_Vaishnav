 ...
 */
public class PaymentConfirmationServiceAsynctask  extends AsyncTask<String, Void, String> {
    ...
    public PaymentConfirmationServiceAsynctask(Activity activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            locationData.put("paid_amount", params[1]);
