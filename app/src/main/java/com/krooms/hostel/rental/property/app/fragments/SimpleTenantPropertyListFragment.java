...
import com.krooms.hostel.rental.property.app.adapter.PropertyListAdapterSimple;
import com.krooms.hostel.rental.property.app.asynctask.GetHostelServiceAsyncTask_tenant;
 ...
 */
public class SimpleTenantPropertyListFragment extends Fragment implements ServiceResponce/*, YouTubePlayer.OnInitializedListener*/ {
    ...
    private PropertyListAdapterSimple mAdapter = null;
...
//    private DisplayImageOptions options = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        convertView = inflater.inflate(R.layout.simple_tenant_property_list_fragment, container, false);
                ...
                if (status.equals("true")) {
                    ...
                    if (dataObject.has("top_three")) {
                        ...
                        for (int j = 0; j < jArray.length(); j++) {
                            ...
                            if (jArray.getJSONObject(j).getString("property_id").equals(bookproeprtyvalue)) {
...
//                                        Common.callImageLoaderSmall(mActivity, WebUrls.IMG_URL + "" + adsArray.getJSONObject(i).getString("url"), adImageFooter, options);
                    ...
                    if (mAdapter == null) {
                        mAdapter = new PropertyListAdapterSimple(mActivity, propertyModal);
                        hostelList.setAdapter(mAdapter);
                        // mAdapter.notifyDataSetChanged();//changes by me
                    } else {
    ...
    public void getPropertyList() {
        ...
        GetHostelServiceAsyncTask_tenant serviceAsyncTask = new GetHostelServiceAsyncTask_tenant(mActivity);
