 ...
 */
public class ShowMonthDetailTenantAdapter extends BaseAdapter {
    ...
    String property_id_value, user_id_value, tenant_id_v;

    public ShowMonthDetailTenantAdapter(Activity context, ArrayList<MonthDetailModalTenant> data_model_arraylist, String property_id_value, String user_id_value) {
