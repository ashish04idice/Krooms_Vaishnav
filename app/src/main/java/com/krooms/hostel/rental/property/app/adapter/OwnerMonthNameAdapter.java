 ...
 */
public class OwnerMonthNameAdapter extends BaseAdapter {

    ArrayList<OwnerStudentNameModel> ownerstudent_arraylist;
    OwnerStudentNameModel ownerstudentmodel;
    private Activity context;

    public OwnerMonthNameAdapter(Activity context, ArrayList<OwnerStudentNameModel> ownerstudent_arraylist) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String countryname =ownerstudent_arraylist.get(position).getMonthname();
        if (countryname!= null) {
