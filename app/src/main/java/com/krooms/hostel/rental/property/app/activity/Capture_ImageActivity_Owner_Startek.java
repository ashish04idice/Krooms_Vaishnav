...
public class Capture_ImageActivity_Owner_Startek extends AppCompatActivity implements FM220_Scanner_Interface {
    ...
    private void showMessageDialogue(String s, String message) {
        new AlertDialog.Builder(Capture_ImageActivity_Owner_Startek.this)
                .setCancelable(false)
                .setTitle(s)
                .setMessage(message)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Capture_ImageActivity_Owner_Startek.this, Finger_Selction_Owner_Activity.class);
    ...
    public void ScannerProgressFM220(final boolean DisplayImage, final Bitmap ScanImage, final boolean DisplayText, final String statusMessage) {
        Capture_ImageActivity_Owner_Startek.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if (DisplayText) {
    ...
    public class SendRecordtoserver extends AsyncTask<String, String, String> {
        ...
        private ProgressDialog dialog = new ProgressDialog(Capture_ImageActivity_Owner_Startek.this);
        ...
        protected String doInBackground(String... params) {
            ...
            listNameValuePairs.add(new BasicNameValuePair("device_type","Startek"));
