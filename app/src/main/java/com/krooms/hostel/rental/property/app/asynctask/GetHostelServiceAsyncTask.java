 ...
 */
public class GetHostelServiceAsyncTask extends AsyncTask<String, Void, String> {
    ...
    public GetHostelServiceAsyncTask(Activity activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            locationData.put("action", "topThreeSearchProperty");
