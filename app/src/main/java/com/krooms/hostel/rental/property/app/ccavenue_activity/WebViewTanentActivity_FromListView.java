...
import com.krooms.hostel.rental.property.app.activity.PDFFileNewPage;
...
public class WebViewTanentActivity_FromListView extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        monthidvaluemain = Integer.parseInt(PaymentActivtyTanent_FromListview.monthid_value);
    ...
    private class RenderView extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(WebViewTanentActivity_FromListView.this);
...
//					GetTransactionDetail();
                    ...
                    String tenantid = ListViewActivityTanent.tenant_idvalue;
                    String userid = PaymentActivtyTanent_FromListview.tanentusrid_value;
                    String roomid = PaymentActivtyTanent_FromListview.tanentroomid_value;
                    String propertyid = PaymentActivtyTanent_FromListview.tanentpropertyid_value;
            ...
            params.append(ServiceUtility.addToPostParams(AvenuesParams.MERCHANT_PARAM6, PaymentActivtyTanent_FromListview.tenantIdValue));
        ...
        try {
            ...
            if (status.equals("true")) {
				...
				/*	if(monthidvaluemain >12)
					{
						monthidvalue= String.valueOf(monthidvaluemain);
...
//					finish();
                if (BillingShippingTanentActivity_FromListView.mActivity != null) {
                    BillingShippingTanentActivity_FromListView.mActivity.finish();
                }
    ...
    private class FineOwnerpaymentJSONParse extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("owner_id", PaymentActivtyTanent_FromListview.tanentownerid_value));
                nameValuePairs.add(new BasicNameValuePair("tenant_id", ListViewActivityTanent.tenant_idvalue));
                nameValuePairs.add(new BasicNameValuePair("user_id", PaymentActivtyTanent_FromListview.tanentusrid_value));
                nameValuePairs.add(new BasicNameValuePair("month_id", monthidvalue));
                nameValuePairs.add(new BasicNameValuePair("year", PaymentActivtyTanent_FromListview.month_date));
                nameValuePairs.add(new BasicNameValuePair("month_name", PaymentActivtyTanent_FromListview.month));
                nameValuePairs.add(new BasicNameValuePair("amount", PaymentActivtyTanent_FromListview.totalAmount_value));
                nameValuePairs.add(new BasicNameValuePair("room_id", PaymentActivtyTanent_FromListview.tanentroomid_value));
                nameValuePairs.add(new BasicNameValuePair("property_id", PaymentActivtyTanent_FromListview.tanentpropertyid_value));
                nameValuePairs.add(new BasicNameValuePair("current_date", PaymentActivtyTanent_FromListview.currentdate_value));
                nameValuePairs.add(new BasicNameValuePair("year", PaymentActivtyTanent_FromListview.year_value_te));
                nameValuePairs.add(new BasicNameValuePair("room_amount", PaymentActivtyTanent_FromListview.monthlypaymentvalue));
                nameValuePairs.add(new BasicNameValuePair("advance_amount", PaymentActivtyTanent_FromListview.monthlypaymentvalue));
        ...
        protected void onPostExecute(String result) {
            ...
            if (!IsError) {
                if (result.equalsIgnoreCase("Y")) {
                    Successdialog();
                    Toast.makeText(WebViewTanentActivity_FromListView.this, "Payment is successfull", Toast.LENGTH_LONG).show();

                } else if (result.equals("N")) {
                    Toast.makeText(WebViewTanentActivity_FromListView.this, message, Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(WebViewTanentActivity_FromListView.this, "please check network connection", Toast.LENGTH_LONG).show();
            }

        }
    }

    public class PaymentActivityOwnerJSONParse extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                // System.out.print("monthid" + monthid_value + "currentdate" + currentdate_value + "owner id" + mSharedStorage.getUserId() + "user id" + tanentusrid_value + "month" + month + "amount" + totalAmount_value + "roomid" + tanentroomid_value + "property id" + mSharedStorage.getBookedPropertyId());
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(7);
                ...
                nameValuePairs.add(new BasicNameValuePair("tenant_id", ListViewActivityTanent.tenant_idvalue));
                nameValuePairs.add(new BasicNameValuePair("year", PaymentActivtyTanent_FromListview.month_date));
                nameValuePairs.add(new BasicNameValuePair("month_id", PaymentActivtyTanent_FromListview.monthid_value));
                nameValuePairs.add(new BasicNameValuePair("month_name", PaymentActivtyTanent_FromListview.month));
                nameValuePairs.add(new BasicNameValuePair("amount", PaymentActivtyTanent_FromListview.totalAmount_value));
                nameValuePairs.add(new BasicNameValuePair("room_id", PaymentActivtyTanent_FromListview.tanentroomid_value));
                nameValuePairs.add(new BasicNameValuePair("room_amount", PaymentActivtyTanent_FromListview.roompay));
                nameValuePairs.add(new BasicNameValuePair("year", PaymentActivtyTanent_FromListview.year_value_te));
                nameValuePairs.add(new BasicNameValuePair("advance_amount", PaymentActivtyTanent_FromListview.advancepay));
                nameValuePairs.add(new BasicNameValuePair("property_id", PaymentActivtyTanent_FromListview.tanentpropertyid_value));
                nameValuePairs.add(new BasicNameValuePair("current_date", PaymentActivtyTanent_FromListview.currentdate_value));
                nameValuePairs.add(new BasicNameValuePair("transaction_mode", "O"));
    ...
    public void Successdialog() {
        final Dialog successdialog = new Dialog(WebViewTanentActivity_FromListView.this);
        ...
        TableRow tableRow = (TableRow) successdialog.findViewById(R.id.tablecomment);
        ...
        download_data_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(WebViewTanentActivity_FromListView.this, PDFFileNewPage.class);
                i.putExtra("p_name", ListViewActivityTanent.property_name_value);
                i.putExtra("name", ListViewActivityTanent.tenant_name_value);
                i.putExtra("date", PaymentActivtyTanent_FromListview.currentdate_value1);
                if (PaymentActivtyTanent_FromListview.type.equalsIgnoreCase("1")) {
                    i.putExtra("month", "Elc-" + PaymentActivtyTanent_FromListview.month);
                } else {
                    i.putExtra("month", PaymentActivtyTanent_FromListview.month);
                }
                i.putExtra("uid", PaymentActivtyTanent_FromListview.tanentusrid_value);
                i.putExtra("amount", PaymentActivtyTanent_FromListview.totalAmount_value);
                i.putExtra("propertyid", PaymentActivtyTanent_FromListview.Bookedpropertykeyid);
                i.putExtra("roomno", PaymentActivtyTanent_FromListview.roomno);
                i.putExtra("keyid", PaymentActivtyTanent_FromListview.keyid);
                i.putExtra("propertyname", mSharedStorage.getPropertyname());
                i.putExtra("mode", "Online");
                startActivity(i);
            }
        });
        username.setText(ListViewActivityTanent.tenant_name_value);
        userdate.setText(PaymentActivtyTanent_FromListview.currentdate_value1);

        if (PaymentActivtyTanent_FromListview.type.equalsIgnoreCase("1")) {

            paymentmonth.setText("Elc-" + PaymentActivtyTanent_FromListview.month);
        } else {
            paymentmonth.setText(PaymentActivtyTanent_FromListview.month);
        }

        userpaid.setText(PaymentActivtyTanent_FromListview.totalAmount_value);
        userpid.setText(PaymentActivtyTanent_FromListview.Bookedpropertykeyid);
        usertid.setText(PaymentActivtyTanent_FromListview.keyid);
        userroomno.setText(PaymentActivtyTanent_FromListview.roomno);
        ...
        nobutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                successdialog.dismiss();
                Intent i = new Intent(WebViewTanentActivity_FromListView.this, ListViewActivityTanent.class);
                i.putExtra("user_name", PaymentActivtyTanent_FromListview.tanentname);
                i.putExtra("user_id_data", PaymentActivtyTanent_FromListview.tanentusrid_value);
                i.putExtra("tid", ListViewActivityTanent.tenant_idvalue);
                i.putExtra("property_id_data", PaymentActivtyTanent_FromListview.tanentpropertyid_value);
    ...
    private void CreatePdf() {
        ...
        try {
            ...
            File file = new File(dir, PaymentActivtyTanent_FromListview.tanentname + " " + "PaySlip" + i1 + ".pdf");
            ...
            table1.addCell(createValueCell(PaymentActivtyTanent_FromListview.currentdate_value));

            table1.addCell(createValueCell("Name"));
            table1.addCell(createValueCell(PaymentActivtyTanent_FromListview.tanentname));

            table1.addCell(createValueCell("Pay For"));
            table1.addCell(createValueCell(PaymentActivtyTanent_FromListview.month));

            table1.addCell(createValueCell("Paid"));
            table1.addCell(createValueCell(PaymentActivtyTanent_FromListview.totalAmount_value));
    ...
    public class GetTransactionTablePaymentStatus extends AsyncTask<String, String, String> {
        ...
        private ProgressDialog dialog = new ProgressDialog(WebViewTanentActivity_FromListView.this);
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (pstatus.equalsIgnoreCase("success") || pstatus.equalsIgnoreCase("Successful") || pstatus.equalsIgnoreCase("successfully") || pstatus.equalsIgnoreCase("Panding")) {
                                ...
                                Toast.makeText(WebViewTanentActivity_FromListView.this, "Your transaction is failed! please try again", Toast.LENGTH_LONG).show();
    ...
    public class ElectricityPaymentOwnerJSONParse extends AsyncTask<String, String, String> {
