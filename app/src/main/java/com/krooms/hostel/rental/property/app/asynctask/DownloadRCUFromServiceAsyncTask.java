 ...
 */
public class DownloadRCUFromServiceAsyncTask extends AsyncTask<String, Void, String> {
    ...
    public DownloadRCUFromServiceAsyncTask(Activity activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            locationData.put("action", "getTanentInfo_pdf");
            locationData.put("table_id", params[0]);
            locationData.put("property_id", params[1]);
            locationData.put("user_id", params[2]);
            locationData.put("purpose", params[3]);
