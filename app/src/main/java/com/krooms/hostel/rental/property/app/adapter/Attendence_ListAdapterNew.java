...
public class Attendence_ListAdapterNew extends BaseAdapter {
    ...
    public Attendence_ListAdapterNew(Activity context, ArrayList<Attendence_Modal> room_model_arraylist, ArrayList<Attendence_Modal> selectedarray) {
