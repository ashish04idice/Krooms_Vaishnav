...
public class OwnerFeedbackListAdapter extends BaseAdapter {
    ...
    public OwnerFeedbackListAdapter(Context lcontext, ArrayList<Feedbackdetailowner> arraylistdetail, ArrayList<Feedbackdetailownernew> arraylistdetailnew) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(v==null){
            ...
            if(Checkreply.equals("1")){
                ...
                holder.textrole.setText("Receive");
                holder.textTenantname.setText("Warden("+arraylistdetail.get(position).getTenant_name()+")");
