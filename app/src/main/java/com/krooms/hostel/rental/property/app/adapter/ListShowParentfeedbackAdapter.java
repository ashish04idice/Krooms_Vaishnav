...
public class ListShowParentfeedbackAdapter extends BaseAdapter {

    Holder holder;
    Context context;
    ArrayList<Complaintdetailtenantnew> arraylistdetailnew;

    public ListShowParentfeedbackAdapter(Context lcontext, ArrayList<Complaintdetailtenantnew> arraylistdetailnew) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            char tnamefirstletter = Tenantname.charAt(0);
            String tenant_fletter = String.valueOf(tnamefirstletter);

            char onamefirstletter = Ownername.charAt(0);
            String owner_fletter = String.valueOf(onamefirstletter);
            ...
            if (CheckReply.equals("2")) {
                holder.textrole.setText("Send");
                holder.textownername.setText("Parent(" + arraylistdetailnew.get(position).getTenant_namenew() + ")");
                holder.textnamelatter.setText("P");
            } else if (CheckReply.equals("1")) {
