...
import com.krooms.hostel.rental.property.app.adapter.listviewshowcomplaintadapter;
...
public class Tenant_Complaint_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    com.krooms.hostel.rental.property.app.adapter.listviewshowcomplaintadapter listviewshowcomplaintadapter;
      ...
      //  new GetWardenId().execute();
        ...
        listViewcompint.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(Tenant_Complaint_Activity.this,Tenant_Complaint_Chat_Activity.class);
       ...
       // Toast.makeText(this, "Currentdate="+date, Toast.LENGTH_LONG).show();
    ...
    public void yeardialogMethod() {
        complaintype = new Dialog(Tenant_Complaint_Activity.this);
        ...
        Month_Custom_List adapter_data_month = new Month_Custom_List(Tenant_Complaint_Activity.this, complain);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.back_button_lefttcomp:
                Intent ii=new Intent(Tenant_Complaint_Activity.this,HostelListActivity.class);
                startActivity(ii);
                break;
    ...
    private void studentdatadialogMethod() {
        ...
        month_dialog=new Dialog(Tenant_Complaint_Activity.this);
        ...
        if(NetworkConnection.isConnected(Tenant_Complaint_Activity.this))
        {
    ...
    private void sendtoserver() {
        ...
        // Toast.makeText(this, "ss="+textcomp, Toast.LENGTH_SHORT).show();
   ...
   // this class is used to save TenantComplaint to server
    public class SendComplaint extends AsyncTask<String, String, String> {

         String wid;

        private ProgressDialog dialog = new ProgressDialog(Tenant_Complaint_Activity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            listNameValuePairs.add(new BasicNameValuePair("action","tenant_complain"));
            ...
            if (result == null) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("Y")) {
                        ...
                        Intent ii=new Intent(Tenant_Complaint_Activity.this,Tenant_Complaint_Activity.class);
                        startActivity(ii);
                        hideSoftKeyboard(Tenant_Complaint_Activity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (!IsError) {
                if (result.equalsIgnoreCase("Y"))
                {
                    ...
                    {
                        OwnerStudentNameTanentAdapter adapter_student = new OwnerStudentNameTanentAdapter(Tenant_Complaint_Activity.this,ownerstudentarraylist);
                        student_list_dialog.setAdapter(adapter_student);
                    }
                } else
                if (result.equalsIgnoreCase("N"))
                {
                    Toast.makeText(Tenant_Complaint_Activity.this,"No Tenant Found", Toast.LENGTH_LONG).show();
                }
            }
            else {
            }
    ...
    public class GetOwnerComplainttenatside extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            ArrayList<NameValuePair> listNameValuePairs;
            listNameValuePairs = new ArrayList<NameValuePair>();
            listNameValuePairs.add(new BasicNameValuePair("action","gettenantcomplainlist"));
            ...
            if (result == null) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("Y")) {
                        ...
                        listviewshowcomplaintadapter=new listviewshowcomplaintadapter(context,arraylistdetailnew,countarray);
