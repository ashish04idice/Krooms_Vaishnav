 ...
 */
public class Parent_Complaint_Chat_Activity extends AppCompatActivity {
    ...
    Intent ii;
    String PropertyId, OwnerId, ComplaintId, TenantId, TenantName, UserId, Date, ParentId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Parent_Complaint_Chat_Activity.this, Parent_Complaint_Activity.class);
        ...
        sendreply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (descriptionvalue.equals("")) {
                    ...
                    Toast.makeText(Parent_Complaint_Chat_Activity.this, "please enter description", Toast.LENGTH_SHORT).show();
    ...
    public class getEventdataJsonCalss extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(Parent_Complaint_Chat_Activity.this);
        ...
        protected void onPostExecute(String th) {
            ...
            if (!IsError) {
                if (result.equals("Y")) {
                    ParentComplaintChatAdapter adapter = new ParentComplaintChatAdapter(Parent_Complaint_Chat_Activity.this, mainarraylist);
                    listView.setAdapter(adapter);
                } else {
                    Toast.makeText(Parent_Complaint_Chat_Activity.this, message, Toast.LENGTH_SHORT).show();
                }
    ...
    public class SendComplaintJsonCalss extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(10);
                nameValuePairs.add(new BasicNameValuePair("action", "parent_complain_reply"));
                nameValuePairs.add(new BasicNameValuePair("property_id", PropertyId));
                nameValuePairs.add(new BasicNameValuePair("owner_id", OwnerId));
                nameValuePairs.add(new BasicNameValuePair("complain_id", ComplaintId));
        ...
        protected void onPostExecute(String th) {
            ...
            if (!IsError) {
                Toast.makeText(Parent_Complaint_Chat_Activity.this, "" + message, Toast.LENGTH_SHORT).show();
                description.setText("");
                Intent i = new Intent(Parent_Complaint_Chat_Activity.this, Parent_Complaint_Chat_Activity.class);
...
//
    ...
    public class GetParentSeen extends AsyncTask<String, String, String> {
        ...
        private ProgressDialog dialog = new ProgressDialog(Parent_Complaint_Chat_Activity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            listNameValuePairs.add(new BasicNameValuePair("action", "parent_read_msg"));
