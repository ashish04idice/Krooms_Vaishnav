...
public class ServiceSyncRecord_Attendance extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        handlerdb = new DatabaseHandler(ServiceSyncRecord_Attendance.this);
        db = handlerdb.getWritableDatabase();
        versionCode = Utility.getSharedPreferences(ServiceSyncRecord_Attendance.this, "GetVersion");
        ...
        if (NetworkConnection.isConnected(ServiceSyncRecord_Attendance.this)) {
    ...
    private void sendOfflineattendance() {
        ...
        if (cc.getCount() != 0) {
            ...
            for (int i = 0; i < attendance_list.size(); i++) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    AppError.handleUncaughtException(e, "ServiceSyncRecord_Attendance_Secugen - attendance_list.size()", propertyid, versionCode);
        ...
        try {
            ...
            e.printStackTrace();
            AppError.handleUncaughtException(e, "ServiceSyncRecord_Attendance_Secugen - sendOfflineattendance()", propertyid, versionCode);
    ...
    public void Sendofflinehostelattendance(final JSONArray attendencelist) {
        try {
            StringRequest postRequest = new StringRequest(Request.Method.POST, WebUrls.MAIN_ATTENDACE_URL,
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            AppError.handleUncaughtException(error, "ServiceSyncRecord_Attendance_Secugen - onErrorResponse", propertyid, versionCode);
                        }
                    }
            ) {
                @Override
           ...
           /* RequestQueue requestQueue = Volley.newRequestQueue(ServiceSyncRecord_Attendance.this);
            requestQueue.add(postRequest);*/

            App.getInstance().addToRequestQueue(postRequest, "tag4");

        } catch (Exception e) {
            e.printStackTrace();
             AppError.handleUncaughtException(e, "ServiceSyncRecord_Attendance_secugen  -Sendofflinehostelattendance 11", propertyid, versionCode);
        }
    }
    ...
    public void getResponsetenantlist(String resultobj) {
        try {
            ...
            e.printStackTrace();
            AppError.handleUncaughtException(e, "ServiceSyncRecord_Attendance_secugen - getResponsetenantlist", propertyid, versionCode);
        }
    }
    ...
    private void SendofflinehostelattendanceFood(final JSONArray jArrayfood) {
        ...
        try {
            ...
            // old working of volley request
/*            RequestQueue requestQueue = Volley.newRequestQueue(ServiceSyncRecord_Attendance.this);
            requestQueue.add(postRequest);*/

            App.getInstance().addToRequestQueue(postRequest, "tag3");
